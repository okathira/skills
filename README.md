...
Each skill lives in its own top-level folder. The folder name matches the skill `name` in `SKILL.md`. An `install/` script copies the skill files (not the catalog README) into agent skill directories.
